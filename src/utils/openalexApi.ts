import { OAAuthorship, OAAutosuggestResult, OAAutosuggestResponse, OAPaper, OAPaperSearchResults } from '../types/openAlexTypes';
...
export function searchOAAutocomplete(query: string): Promise<PaperAutosuggest[]> {
    if (query) {
        return axios
            .get(
