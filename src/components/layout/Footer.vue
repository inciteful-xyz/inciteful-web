<template>
  <footer class="bg-theme-lavender border-t border-theme-pink" role="contentinfo">
    <div class="max-w-screen-xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex justify-center gap-4 mb-6">
        <a
          ...
          class="text-theme-charcoal hover:text-theme-violet transition-colors"
        ...
        <a
          href="https://github.com/inciteful-xyz/inciteful-web"
          target="_blank"
          rel="noopener noreferrer"
          class="text-theme-charcoal hover:text-theme-violet transition-colors"
          aria-label="View Inciteful on GitHub (opens in new tab)"
        >
      ...
      <div class="text-center mb-4">
        <p class="text-sm text-theme-charcoal">
          Help support free open source tools for academics. If you found this site helpful, please cite it:
        </p>
        <p class="text-sm text-theme-charcoal mt-1">
          Weishuhn, M. ({{ year }}). Inciteful: Citation network exploration. Retrieved from {{ siteUrl }}
        </p>
      </div>
