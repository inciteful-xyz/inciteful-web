<template>
  <div class="px-6 py-6 bg-violet-700 rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
    ...
    <div class="xl:w-0 xl:flex-1" v-if="!isSubmitted">
      ...
      <p class="mt-3 max-w-3xl text-lg leading-6 text-violet-200" id="newsletter-headline">
    ...
    <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8" v-if="!isSubmitted">
      <form class="sm:flex" aria-labelledby="newsletter-headline" @submit.prevent="handleSubmit">
        ...
        <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
          <button class="button-light-violet w-full px-5 py-3 leading-6 text-base">
            Join
          </button>
        </div>
      </form>
